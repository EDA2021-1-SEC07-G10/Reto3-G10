...
def requerimiento_2(min_Energy, max_Energy, min_Danceability, max_Danceability, catalog):
    
    arbol_dance = catalog['propiedades']['danceability']
    lista = om.values(arbol_dance, min_Danceability, max_Danceability)
 #   cadena = lt.newList("ARRAY_LIST")  
